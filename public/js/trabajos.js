...
$(function () {
    ...
    var tabla = 'trabajos';
    var campo = 'id_trabajo';
    var id_estatus = 'estatus_trab';
    ...
    $("#clear").click(function () {
        location.href = base_url+'routing/bandeja/trabajos/';
    });
    ...
    $('#formSearch').formValidation({
        ...
        //e.preventDefault();
        var $form = $(e.target);
        $form.attr('action',base_url+'routing/bandeja/trabajos/'+$('#fechain').val()+'_'+$('#fechaen').val());
    });
